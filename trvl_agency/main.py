...
if os.path.exists('trvlag.db'):
    ...
    cur.execute("INSERT INTO location(COUNTRY_NAME,S_DATE,E_DATE,PRICE,SPOT_AVAILABLE) VALUES ('Canada', '2021-05-05', '2021-09-22', '1200', '5')")
...
print("Are you an existing user? Press 2 to login!")
